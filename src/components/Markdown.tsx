...
const components = {
  h1: ({ ...props }) => <Typography component="div" variant="h4" {...props} />,
  h2: ({ ...props }) => <Typography component="div" variant="h4" {...props} />,
  h3: ({ ...props }) => <Typography component="div" variant="h4" {...props} />,
